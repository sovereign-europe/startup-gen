...
const BaseDivider: React.FC<DividerProps> = ({ width = "auto", dividerChar, dividerColor = "gray", boxProps }) => (
  <Box
    width={width}
...
const Divider: React.FC<DividerProps> = ({
  ...
  const dividerLine = <BaseDivider dividerChar={dividerChar} dividerColor={dividerColor} boxProps={boxProps} />
